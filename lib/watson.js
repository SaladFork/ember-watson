...
var computedDecoratorTransform = require('./formulas/computed-decorator-transform');
...
EmberWatson.prototype._transformComputedDecorators = computedDecoratorTransform;

EmberWatson.prototype.transformComputedDecorators = function(rootPath) {
  var files = findFiles(rootPath, '.js');

  transform(files, this._transformComputedDecorators);
};
